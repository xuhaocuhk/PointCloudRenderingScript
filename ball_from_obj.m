...
BALL_SIZE = 0.005;
base_path = '../p2f/kitten/'

file_names = dir([base_path, '*.obj']);
...
for file = file_names'
    ...
    for i = 1:keypts_num
        ...
        V_total( (vertex_num*(i-1)+1): vertex_num*i, :) = [V_new color_mat*255 ones(vertex_num, 1)*255];
